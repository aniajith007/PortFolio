  ...
  return (
    <>
      ...
      <>
          ...
          {link.name==='github'?<a href={link.href}><li className="m-2 mb-4  hover:text-green-400 transition ease-in-out hover:-translate-y-1 hover:scale-100  duration-100">            
            <svg
          ...
          {link.name==='instagram'?<a href={link.href}><li className="m-2 mb-4  hover:text-green-400  transition ease-in-out hover:-translate-y-1 hover:scale-100  duration-100" >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          {link.name === 'linkedin'?<a href={link.href}><li className="m-2 mb-4  hover:text-green-400  transition ease-in-out hover:-translate-y-1 hover:scale-100  duration-100" href ={link.href}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
